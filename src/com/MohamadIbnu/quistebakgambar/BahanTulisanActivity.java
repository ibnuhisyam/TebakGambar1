...
public class BahanTulisanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bahan_tulisan);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "BAHAN TULISAN";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), BintangKecilActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bahan_tulisan, menu);
		return true;
	}
