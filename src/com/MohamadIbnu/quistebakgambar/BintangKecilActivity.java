...
public class BintangKecilActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bintang_kecil);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "BINTANG KECIL";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), BiroDagangActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bintang_kecil, menu);
		return true;
	}
