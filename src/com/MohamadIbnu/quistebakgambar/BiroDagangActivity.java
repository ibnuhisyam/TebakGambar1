...
public class BiroDagangActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_biro_dagang);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "BIRO DAGANG";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), BlangkoPermohonanActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.biro_dagang, menu);
		return true;
	}
