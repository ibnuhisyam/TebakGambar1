...
public class BlangkoPermohonanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_blangko_permohonan);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "BLANGKO PERMOHONAN";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), DarahPanasActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.blangko_permohonan, menu);
		return true;
	}
