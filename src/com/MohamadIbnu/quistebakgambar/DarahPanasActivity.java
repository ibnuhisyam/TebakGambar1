...
public class DarahPanasActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_darah_panas);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "DARAH PANAS";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), GadisBisuActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.darah_panas, menu);
		return true;
	}
