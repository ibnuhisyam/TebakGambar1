...
public class GadisBisuActivity extends Activity {
	//deklarasi variabel
		EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_gadis_bisu);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "GADIS BISU SUKA MERANGKUL GULING DIRUANG PRIBADI";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), HampirPirangActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gadis_bisu, menu);
		return true;
	}
