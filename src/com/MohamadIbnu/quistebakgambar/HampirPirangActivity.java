...
public class HampirPirangActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hampir_pirang);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "HAMPIR PIRANG";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), HormatiGadisActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.hampir_pirang, menu);
		return true;
	}
