...
public class KakiPerawanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_kaki_perawan);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "KAKI PERAWAN";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), MencelaNasihatActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kaki_perawan, menu);
		return true;
	}
