...
public class MencelaNasihatActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mencela_nasihat);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "MENCELA NASIHAT";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), ObatiKesepianActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mencela_nasihat, menu);
		return true;
	}
