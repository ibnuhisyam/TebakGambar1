...
public class ObatiKesepianActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_obati_kesepian);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "OBATI KESEPIAN";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), PejabatTurunActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.obati_kesepian, menu);
		return true;
	}
