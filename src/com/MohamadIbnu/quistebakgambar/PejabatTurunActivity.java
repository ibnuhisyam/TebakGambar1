...
public class PejabatTurunActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pejabat_turun);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "PEJABAT TURUN LAPANGAN HADAPI DEMO NASIB BURUK PENDUDUK MALAS";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), PelayanWarungActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pejabat_turun, menu);
		return true;
	}
