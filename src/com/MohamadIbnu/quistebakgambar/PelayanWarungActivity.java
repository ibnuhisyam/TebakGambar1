...
public class PelayanWarungActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pelayan_warung);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "PELAYAN WARUNG";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), PersentaseTiruanActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pelayan_warung, menu);
		return true;
	}
