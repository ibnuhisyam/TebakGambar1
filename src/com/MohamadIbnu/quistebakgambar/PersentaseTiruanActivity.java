...
public class PersentaseTiruanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_persentase_tiruan);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "PERSENTASE TIRUAN";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), PinjamBankActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.persentase_tiruan, menu);
		return true;
	}
