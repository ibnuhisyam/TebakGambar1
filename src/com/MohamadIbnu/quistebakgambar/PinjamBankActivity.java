...
public class PinjamBankActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pinjam_bank);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "PINJAM BANK";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), ResikoBoikotActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pinjam_bank, menu);
		return true;
	}
