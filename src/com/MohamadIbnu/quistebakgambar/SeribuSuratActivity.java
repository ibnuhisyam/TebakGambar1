...
public class SeribuSuratActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_seribu_surat);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "SERIBU SURAT";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), SifatTerpendamActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.seribu_surat, menu);
		return true;
	}
