...
public class SifatTerpendamActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sifat_terpendam);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "SIFAT TERPENDAM";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), TularPenyakitActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sifat_terpendam, menu);
		return true;
	}
