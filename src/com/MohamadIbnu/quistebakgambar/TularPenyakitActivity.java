...
public class TularPenyakitActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tular_penyakit);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "TULAR PENYAKIT";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tular_penyakit, menu);
		return true;
	}
